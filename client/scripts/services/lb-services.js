  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Race.participants.findById() instead.
        "prototype$__findById__participants": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Races/:id/participants/:fk",
          method: "GET"
        },

        // INTERNAL. Use Race.participants.destroyById() instead.
        ...
        // INTERNAL. Use Race.participants.updateById() instead.
        ...
        // INTERNAL. Use Race.participants() instead.
        "prototype$__get__participants": {
          isArray: true,
          url: urlBase + "/Races/:id/participants",
          method: "GET"
        },

        // INTERNAL. Use Race.participants.create() instead.
        "prototype$__create__participants": {
          url: urlBase + "/Races/:id/participants",
          method: "POST"
        },

        // INTERNAL. Use Race.participants.destroyAll() instead.
        "prototype$__delete__participants": {
          url: urlBase + "/Races/:id/participants",
          method: "DELETE"
        },

        // INTERNAL. Use Race.participants.count() instead.
        "prototype$__count__participants": {
          url: urlBase + "/Races/:id/participants/count",
          method: "GET"
        },
        ...
        // INTERNAL. Use Participant.race() instead.
        "::get::Participant::race": {
          url: urlBase + "/Participants/:id/race",
          method: "GET"
        },
      }
    );
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.Race.participants
     * @header lbServices.Race.participants
     * @object
     * @description
     *
     * The object `Race.participants` groups methods
     * manipulating `Participant` instances related to `Race`.
     *
     * Call {@link lbServices.Race#participants Race.participants()}
     * to query all related instances.
     */
        ...
        R.participants = function() {
          ...
          var action = TargetResource["::get::Race::participants"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Race.participants#count
         * @methodOf lbServices.Race.participants
         *
         * @description
         *
         * Counts participants of Race.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.participants.count = function() {
          var TargetResource = $injector.get("Participant");
          var action = TargetResource["::count::Race::participants"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Race.participants#create
         * @methodOf lbServices.Race.participants
         *
         * @description
         *
        ...
        R.participants.create = function() {
          var TargetResource = $injector.get("Participant");
          var action = TargetResource["::create::Race::participants"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Race.participants#createMany
         * @methodOf lbServices.Race.participants
         *
         * @description
         *
        ...
        R.participants.createMany = function() {
          var TargetResource = $injector.get("Participant");
          var action = TargetResource["::createMany::Race::participants"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Race.participants#destroyAll
         * @methodOf lbServices.Race.participants
         *
         * @description
         *
        ...
        R.participants.destroyAll = function() {
          var TargetResource = $injector.get("Participant");
          var action = TargetResource["::delete::Race::participants"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Race.participants#destroyById
         * @methodOf lbServices.Race.participants
         *
         * @description
         *
        ...
        R.participants.destroyById = function() {
          var TargetResource = $injector.get("Participant");
          var action = TargetResource["::destroyById::Race::participants"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Race.participants#findById
         * @methodOf lbServices.Race.participants
         *
         * @description
         *
        ...
        R.participants.findById = function() {
          var TargetResource = $injector.get("Participant");
          var action = TargetResource["::findById::Race::participants"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Race.participants#updateById
         * @methodOf lbServices.Race.participants
         *
         * @description
         *
        ...
        R.participants.updateById = function() {
          var TargetResource = $injector.get("Participant");
          var action = TargetResource["::updateById::Race::participants"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Race.participants.createMany() instead.
        "::createMany::Race::participants": {
          isArray: true,
          url: urlBase + "/Races/:id/participants",
          method: "POST"
        },
    ...
    */
    R.modelName = "Participant";
        ...
        /**
         * @ngdoc method
         * @name lbServices.Participant#race
         * @methodOf lbServices.Participant
         *
         * @description
         *
         * Fetches belongsTo relation race.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.race = function() {
          var TargetResource = $injector.get("Race");
          var action = TargetResource["::get::Participant::race"];
          return action.apply(R, arguments);
        };
